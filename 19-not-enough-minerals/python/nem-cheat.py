# I couldn't figure out how to get this done efficiently. This solution taken from https://www.reddit.com/r/adventofcode/comments/zpihwi/comment/j0wtmjq/?utm_source=share&utm_medium=web2x&context=3
...
bps = list(map(parse_blueprint, open(inputPath).read().split('\n')))
print(sum((i + 1) * largest_for_bp(bp, 24) for i, bp in enumerate(bps)))
print(math.prod(largest_for_bp(bp, 32) for bp in bps[:3]))
