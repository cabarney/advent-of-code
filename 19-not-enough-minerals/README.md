...
> Full disclosure for today's challenge: I blatently copied a posted solution after not being able to get anywhere with this. My solution is far too slow and inefficient. It arrives at the right answer for a given blueprint, but will also run out of memory for others. 
> 
> Solution copied from Reddit user @DrunkHacker [here](https://www.reddit.com/r/adventofcode/comments/zpihwi/comment/j0wtmjq/?utm_source=share&utm_medium=web2x&context=3)
